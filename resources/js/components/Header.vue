            ...
            <div id="app-sidepanel" class="app-sidepanel"> 
               ...
               <div class="sidepanel-inner d-flex flex-column">
                  ...
                  <div class="app-branding">
                        <router-link class="app-logo" to="/"><img class="logo-icon mr-2" src="assets/images/app-logo.svg" alt="logo"><span class="logo-text">Dashboard</span></router-link>
                  ...
                  <nav id="app-nav-main" class="app-nav app-nav-main flex-grow-1">
                     <ul class="app-menu list-unstyled accordion" id="menu-accordion">
                        <li class="nav-item">
                           <router-link class="nav-link" to="/nav">
                              <span class="nav-icon">
                        ...
                        <li class="nav-item">
                           <router-link class="nav-link" to="/manage-tag">
                              <span class="nav-icon">
